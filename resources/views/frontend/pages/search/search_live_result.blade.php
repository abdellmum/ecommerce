<table>
	...
	@forelse($products as $row)
        <tr class="mt-3 d-block">
            ...
            <td class=" px-4"><a style="border-bottom: 1px solid black; font-size: 20px;" href="{{ url('/product/subcategory/'.$row->subcategory_id.'/'.$row->subcategory_name) }}">{{$row->product_name}}</a></td>
        </tr>
       @empty
